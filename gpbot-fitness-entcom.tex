...
This work presents a Genetic Programming (GP) algorithm to create the behavioural engine of bots able to play a RTS. Three different fitness functions are proposed and a detailed analysis on their performance has been conducted. The aim is to get a better deal with this uncertainty. 
...
As a general conclusion a victory-based fitness, which prioritizes the number of victories, contributes to generate better bots, on average, than other functions based on numerical aspects of the battles, such as the number of resources gathered, or the number of units generated. 
\end{abstract}
