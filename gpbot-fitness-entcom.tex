...
% Antonio - hay que corregir el título, debería poner algo como
% "Victories of everyone of the best individuals per execution versus
% the rest of best", pero no "each best individuals"
% También la figura. Pone "fitness method" y luego "fitness" en cada
% box. - JJ
...
%Ya empezamos con "la figura 10 muestra esto, la 11 dice
%aquello". Tienes que contar un argumento - JJ
...
%Why do you want to show this? - JJ
...
victory. 
%Para esto no hace falta poner la _evolución_. Estáis analizando los
%resultados finales. ¿Qué más da el valor que tengan al principio? - JJ
  ...
  \caption{Evolution of the percentage of every condition over the
    ...
    every execution.} 
% Realmente, no veo nada en esta gráfica. En unos casos aumenta, en
% otros disminuye. ¿Qué conclusión quieres sacar? - JJ
...
the others the {\em reinforcement} one with respect to attacking. %No
                                %entiendo - JJ
 This
...
% % ANTARES: Exacto, he re-hecho todo el estudio para mostrar la
% % eváluación de los individuos pero de cada fitness. De hecho, Fergu
% % ha sacado un par de conclusiones bastante interesantes sobre ese
% % estudio.
% Ya estamos en la segunda vuelta, pero da igual. Si se usa en las
% conclusiones, lo tenéis qeu decir desde el principio. - JJ
