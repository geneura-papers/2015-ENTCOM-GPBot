...
%ANTARES: No es del n�mero ''generado'' sino el n�mero total en juego. Lo intento corregir.
% Antonio - Ok
\end{itemize}
...
% - �Algo del ruido?
% ANTARES: Lo del estudio de profundidad se hizo en el primer art�culo de GP-BOT del EVOSTAR, y se hizo mejor que aqu�.
% Antonio - No es un estudio DE profundidad, sino EN profundidad. XD
%           Vamos, que se van a mirar los �rboles generados con detenimiento 
%           (me refiero a lo de las condiciones y acciones utilizadas. ;)

We used GP in a previous approach for Planet Wars bots \cite{Garcia14Treedepth}, as a following step to those works, to avoid the strict limitations that the initial bots had, such as the fixed behavioural structure (a Finite State Machine), which just offers a few degrees of improvement, namely the evolved set of eight parameters.
