...
\begin{figure}[ht]
 ...
 \end{center}
 \caption{Boxplot of average percentage of victories of the bots obtained by each approach vs ANONIMOUSBOT. 9 different matches have been performed per bot in different maps.} 
...
not use Genetic Programming \cite{Mora_noisy_jcst}.
...
%This work presents a Genetic Programming algorithm that generates agents for playing the Planet Wars game. A number of possible actions to perform and decision variables have been presented. A competitive bot available in the literature (ANONIMOUSBOT) has been used to calculate the fitness of the generated individuals. This bot was the best obtained from several runs and the behaviour to be optimized was extracted from human expertise. %FERGU: confirmarlo %FERGU2: quitado exp-genebot y reescrito a continuaciÃ³n
...
available in the literature (ANONIMOUSBOT) has been used to evaluate the
