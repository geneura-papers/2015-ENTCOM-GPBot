...
\ead{\{antares, amorag, pgarcia, pedro, merelo\}@geneura.ugr.es}
...
%
\begin{abstract}
The design of the Artificial Intelligence (AI) engine for an autonomous agent (bot) in a game is always a difficult task mainly done by an expert human player, who has to transform his/her knowledge into a behavioural engine.
...
This algorithm is applied to design decision trees to be used as bot's AI in 1 vs 1 battles inside the RTS game Planet Wars. 
