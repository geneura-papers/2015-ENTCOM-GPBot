...
This paper describes the application of a GP approach inside a `simple' RTS, Planet Wars, in order to define the whole behavioural engine for bot. However several approaches, based on three different fitness functions have been tested.
...
% Antonio - TODO - Alguna cita más, Fergu (de los de Málaga por ejemplo).
...
The present paper goes another step further and analyses the influence of different fitness functions on the algorithms performance and also on the generated individuals (bots). 
% Antonio - TODO - Fergu, añade aquí alguna referencia más a estudios de fitness en juegos
