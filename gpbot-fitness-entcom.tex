...
However, the techniques applied to do this must deal with uncertainty
...
This work uses a Genetic Programming (GP) algorithm to create the
...
and a detailed analysis of their
performance has been conducted. The aim is to deal with
this uncertainty. % Why? Are they statistically distributed better? If
...
As a general conclusion a victory-based fitness, which prioritises the
...
generated.  % that is not a conclusion. That is a result. The
...
\begin{tabular}{|r|r|r|r|}
 ...
 Fitness Method & Wins & Defeats & Draws \\ 
  \hline \hline
VICTORIES FITNESS & 12027 & \textbf{4033} & \textbf{7754} \\ 
  AREA FITNESS & \textbf{13423} & 6047 & 4344 \\ 
  SLOPE FITNESS & 10976 & 9914 & 2924 \\ 
   \hline
\end{tabular}
\end{table}
